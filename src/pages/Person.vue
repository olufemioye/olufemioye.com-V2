	...
	<section class="page-person page-section" style="padding-bottom: 0" data-aos="fade-up">
		<div class="page-container">
			...
			<div class="page-content text-grey">
				...
				<p class="body-text">
					When I’m not designing I am basically just living and enjoying the simple things in life. I take my sleep and food pretty serious. I plan to add travel and art collection to this list.
				</p>
				<p class="body-text">
					I’m always listening to something, be it a playlist on Spotify, a fake woke podcast or my friends ranting about the life and times of the everyday Nigerian.
				</p>
			</div>
